...
struct Queue<T> {
    ...
    var isEmpty: Bool {
        return front > elements.count - 1
    }
    
    var peek: T? {
        return !isEmpty ? elements[front] : nil
    }
    ...
    var count: Int {
        return !isEmpty ? elements.count - front : 0
    }
